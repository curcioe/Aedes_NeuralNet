...
def get_era5_data_from_tiff(latitude, longitude, date_str, bands):
    try:
        ...
        for band in bands:
            file_path = f"../era5/{date_str}.{band}.tif"
...
def generate_pseudo_absences(input_file, output_file, absence_ratio, num_days=365, bands=None, batch_size=10):
    if bands is None:
        bands = ['dewpoint_2m_temperature', 'maximum_2m_air_temperature', 'mean_2m_air_temperature', 
                 'minimum_2m_air_temperature', 'surface_pressure', 'total_precipitation', 'u_component_of_wind_10m', 'v_component_of_wind_10m']
...
if __name__ == "__main__":
    input_csv = '../datasets/aedes_aegypti.csv'
    output_real_csv = '../datasets/aedes_aegypti_real.csv'
    ...
    absence_ratio = 10
    pseudo_absence_output_csv = '../datasets/aedes_aegypti_absence.csv'
    generate_pseudo_absences(output_real_csv, pseudo_absence_output_csv, absence_ratio, num_days=365)

    # Merge real and pseudo-absences into one file
    training_output_csv = '../datasets/aedes_aegypti_dataset_raw.csv'
